    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                title = { Text(text = "Add Expenditure Bill") },
        ...
        // 定义类别选项列表
        val categories = listOf("Dining", "Shopping", "Daily Use", "Transportation", "Sports", "Entertainment", "Accommodation","Other")
